...
const Footer = () => {
    return (
        <footer className='bg-indigo-100 w-full py-8'>
            <div className='max-w-screen-xl mx-auto px-4'>
                <div className=' flex max-w-xs mx-auto items-center justify-between'>
                    <a
                        href='https://github.com/shakilahmedatik'
                        className='text-indigo-900 hover:text-gray-800 transition-colors duration-200'
                    >
                        <svg
                            width='20'
                            height='20'
                ...
                <div className='text-center text-indigo-900 pt-10 sm:pt-12 font-light flex items-center justify-center'>
